...
It is possible to query user and group data from LDAP servers. This may be used
to build special filter rules, or just to provide authentication services for
the Spam quarantine GUI.
...
Combined role permissions of the 'Auditor' and the 'Quarantine Manager' role.
